...
class FbdjHostTest {
		...
		def test():Unit={
		  val exception = try{
			...
			val existing = new FbdjHost("C:\\Users\\ulf\\Desktop\\fbdj\\FBDj.jar", "C:\\Users\\ulf\\.m2\\repository\\de\\immaterialien\\FBDj-overrides\\0.0.1-SNAPSHOT\\FBDj-overrides-0.0.1-SNAPSHOT.jar", "confPath")
